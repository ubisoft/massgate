...
#ifndef MSB_HASHTABLE_H
#define MSB_HASHTABLE_H
...
typedef uint32 MSB_Hash;

class MSB_StandardHashHelper
{
public:
	static MSB_Hash		Hash1(int32 aValue);
	static MSB_Hash		Hash2(int32 aValue);
	static int32		Retain(int32 aValue);
	static void			Release(int32 aValue);
	static bool			Equal(int32 aValue1, int32 aValue2);

	static MSB_Hash		Hash1(const char* aValue);
	static MSB_Hash		Hash2(const char* aValue);
	...
	static MSB_Hash			Hash1(const wchar_t* aValue);
	static MSB_Hash			Hash2(const wchar_t* aValue);
	static const wchar_t*	Retain(const wchar_t* aValue);
	static void				Release(const wchar_t* aValue);
	static bool				Equal(const wchar_t* aString1, const wchar_t* aString2);	
	
	// FIXME: MY EYES!!
	static MSB_Hash		Hash1(void* aValue) { return Hash1((int32) (int64) aValue); }
	static MSB_Hash		Hash2(void* aValue) { return Hash2((int32) (int64) aValue); }
...
template <typename T>
extern void
MSB_StandardDeleteObjectPointer(T& anItem)
{
	delete anItem;
}
 ...
 * MSB_StandardDeleteObjectPointer, if you want to retain ownership use MSB_StandardDummy.
 *
 ...
 */
template <typename Key, typename Item, void (*DeleteFunction)(Item&) = MSB_StandardDummy<Item>, typename HashHelper = MSB_StandardHashHelper >
class MSB_HashTable : MSB_IMap<Key, Item>
{
public:
	class Iterator
	{
	public:
							Iterator(
								MSB_HashTable<Key, Item, DeleteFunction, HashHelper>&		aHashTable);
	...
	private:
		MSB_HashTable<Key, Item, DeleteFunction, HashHelper>&			myHashTable;
		typename MSB_HashTable<Key, Item, DeleteFunction, HashHelper>::HashItem*	myList;
...
MSB_HashTable<Key, Item, DeleteFunction, HashHelper>::MSB_HashTable(
	uint32		aSize)
	: mySize(aSize)
	, myNumUsed(0)
	, myUsedList1(0)
...
template <typename Key, typename Item, void (*DeleteFunction)(Item&), typename HashHelper>
void
MSB_HashTable<Key, Item, DeleteFunction, HashHelper>::Add(
	const Key& aKey, 
	const Item& anItem)
{
...
template <typename Key, typename Item, void (*DeleteFunction)(Item&), typename HashHelper>
void
MSB_HashTable<Key, Item, DeleteFunction, HashHelper>::Remove(
	const Key& aKey)
{
...
template <typename Key, typename Item, void (*DeleteFunction)(Item&), typename HashHelper>
bool
MSB_HashTable<Key, Item, DeleteFunction, HashHelper>::Get(
	const Key&	aKey, 
	Item&		anItem)
{
...
template <typename Key, typename Item, void (*DeleteFunction)(Item&), typename HashHelper>
bool
MSB_HashTable<Key, Item, DeleteFunction, HashHelper>::HasKey(
	const Key&	aKey)
{
...
template <typename Key, typename Item, void (*DeleteFunction)(Item&), typename HashHelper>
void
MSB_HashTable<Key, Item, DeleteFunction, HashHelper>::PrivInsert(
	const HashItem&		anItem)
{
 ...
 */
template <typename Key, typename Item, void (*DeleteFunction)(Item&), typename HashHelper>
typename MSB_HashTable<Key, Item, DeleteFunction, HashHelper>::HashItem*
MSB_HashTable<Key, Item, DeleteFunction, HashHelper>::PrivFind(
	const Key& aKey)
{
	MSB_Hash		h = HashHelper::Hash1(aKey) % myListSize;
...
template <typename Key, typename Item, void (*DeleteFunction)(Item&), typename HashHelper>
void
MSB_HashTable<Key, Item, DeleteFunction, HashHelper>::PrivTrimTo2Exp()
{
...
template <typename Key, typename Item, void (*DeleteFunction)(Item&), typename HashHelper>
void
MSB_HashTable<Key, Item, DeleteFunction, HashHelper>::PrivRehash()
{
...
template <typename Key, typename Item, void (*DeleteFunction)(Item&), typename HashHelper>
Item&
MSB_HashTable<Key, Item, DeleteFunction, HashHelper>::operator[] (
	const Key&		aKey)
{
	HashItem*		item = PrivFind(aKey);
	return item->myItem;
...
template <typename Key, typename Item, void (*DeleteFunction)(Item&), typename HashHelper>
MSB_HashTable<Key, Item, DeleteFunction, HashHelper>::Iterator::Iterator(
	MSB_HashTable<Key, Item, DeleteFunction, HashHelper>&		aHashTable)
...
template <typename Key, typename Item, void (*DeleteFunction)(Item&), typename HashHelper>
bool
MSB_HashTable<Key, Item, DeleteFunction, HashHelper>::Iterator::Next()
{
...
template <typename Key, typename Item, void (*DeleteFunction)(Item&), typename HashHelper>
const Key&
MSB_HashTable<Key, Item, DeleteFunction, HashHelper>::Iterator::GetKey() const
{
...
template <typename Key, typename Item, void (*DeleteFunction)(Item&), typename HashHelper>
Item&
MSB_HashTable<Key, Item, DeleteFunction, HashHelper>::Iterator::GetItem()
{
